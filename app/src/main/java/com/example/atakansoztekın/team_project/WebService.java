...
/**
 * Created by Kerem on 17.12.2017.
 */
...
public class WebService {
    ...
    public static String getRequest(String urlStr) {
        ...
        try {
            ...
            conn.setReadTimeout(1000); //maximum time to wait for an input stream read
            conn.setConnectTimeout(1500); //maximum time to wait while connecting
